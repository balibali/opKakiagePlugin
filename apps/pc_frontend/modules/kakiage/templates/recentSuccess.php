<div id="kakiageRecent">
<div id="kakiages" class="parts">
<div class="partsHeading"><h3><?php echo __('Recently List') ?></h3></div>
...
<div class="editLink"><?php echo link_to(__('Edit'), '@kakiage_edit_date?'.strftime('year=%Y&month=%m&day=%d', strtotime($item['target_date']))) ?></div>
