...
<div id="topEditLink" class="editLink"><?php echo link_to(__('Edit'), 'kakiage/edit') ?></div>

<?php foreach ($list as $item): ?>
<div id="id_<?php echo $item['Member']->getId() ?>" class="kakiage">
<?php if ($sf_user->getMemberId() === $item['Member']->getId()): ?>
<div class="editLink"><?php echo link_to(__('Edit'), 'kakiage/edit') ?></div>
<?php endif; ?>
...
<div id="bottomEditLink" class="editLink"><?php echo link_to(__('Edit'), 'kakiage/edit') ?></div>
